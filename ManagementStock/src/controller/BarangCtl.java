...
public class BarangCtl {
    ...
    private static final String QUERY_SELECT_NAMA = "select nama from barang order by id asc";
    ...
    public void TampilCombo() {
        try (PreparedStatement p = db.prep(QUERY_SELECT_NAMA)) {
            ResultSet r = p.executeQuery();

            while (r.next()) {
                Object[] ob = new Object[1];
                ob[0] = r.getString(1);
                frame.getComboNama().addItem(ob[0]);
            }
